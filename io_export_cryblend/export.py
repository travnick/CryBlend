...
class CrytekDaeExporter:
    ...
    def vsp(self, objects, node1):
        ...
        def extract_anil(self, i, ax):#RED_THREE
            ...
            for fcu in curves:
                ...
                if fcu.data_path == 'location'and fcu.array_index == 0:
                    ...
                    sinpx.setAttribute("id", i.name+"s_location_"+ax+"-input")
                    inpxfa = doc.createElement("float_array")
                    inpxfa.setAttribute("id", i.name+"s_location_"+ax+"-input-array")
                    ...
                    accinpx.setAttribute("source", "#"+i.name+"s_location_"+ax+"-input-array")
                    ...
                    soutpx.setAttribute("id", i.name+"s_location_"+ax+"-output")
                    outpxfa = doc.createElement("float_array")
                    outpxfa.setAttribute("id", i.name+"s_location_"+ax+"-output-array")
                    ...
                    accoutpx.setAttribute("source", "#"+i.name+"s_location_"+ax+"-output-array")
                    ...
                    sintpx.setAttribute("id", i.name+"s_location_"+ax+"-interpolation")
                    intpxfa = doc.createElement("Name_array")
                    intpxfa.setAttribute("id", i.name+"s_location_"+ax+"-interpolation-array")
                    ...
                    accintpx.setAttribute("source", "#"+i.name+"s_location_"+ax+"-interpolation-array")
                    ...
                    sintangpx.setAttribute("id", i.name+"s_location_"+ax+"-intangent")
                    intangpxfa = doc.createElement("float_array")
                    intangpxfa.setAttribute("id", i.name+"s_location_"+ax+"-intangent-array")
                    ...
                    accintangpx.setAttribute("source", "#"+i.name+"s_location_"+ax+"-intangent-array")
                    ...
                    soutangpx.setAttribute("id", i.name+"s_location_"+ax+"-outtangent")
                    outangpxfa = doc.createElement("float_array")
                    outangpxfa.setAttribute("id", i.name+"s_location_"+ax+"-outtangent-array")
                    ...
                    accoutangpx.setAttribute("source", "#"+i.name+"s_location_"+ax+"-outtangent-array")
                    ...
                    chanx.setAttribute("source", "#"+i.name+"s_location_"+ax+"-sampler")
                    chanx.setAttribute("target", i.name+"s/translation."+ax)
        ...
        # rotation_euler
                if fcu.data_path == 'rotation_euler'and fcu.array_index == 0:
                    ...
                    # input
                    sinpx = doc.createElement("source")
                    sinpx.setAttribute("id", i.name+"s_rotation_euler_"+ax+"-input")
                    inpxfa = doc.createElement("float_array")
                    inpxfa.setAttribute("id", i.name+"s_rotation_euler_"+ax+"-input-array")
                    inpxfa.setAttribute("count", "%s" % (ii))
                    sinpxdat = doc.createTextNode("%s" % (inpx))
                    inpxfa.appendChild(sinpxdat)
                    tcinpx = doc.createElement("technique_common")
                    accinpx = doc.createElement("accessor")
                    accinpx.setAttribute("source", "#"+i.name+"s_rotation_euler_"+ax+"-input-array")
                    accinpx.setAttribute("count", "%s" % (ii))
                    accinpx.setAttribute("stride", "1")
                    parinpx = doc.createElement("param")
                    parinpx.setAttribute("name", "TIME")
                    ...
                    # output
                    soutpx = doc.createElement("source")
                    soutpx.setAttribute("id", i.name+"s_rotation_euler_"+ax+"-output")
                    outpxfa = doc.createElement("float_array")
                    outpxfa.setAttribute("id", i.name+"s_rotation_euler_"+ax+"-output-array")
                    outpxfa.setAttribute("count", "%s" % (ii))
                    soutpxdat = doc.createTextNode("%s" % (outpx))
                    outpxfa.appendChild(soutpxdat)
                    tcoutpx = doc.createElement("technique_common")
                    accoutpx = doc.createElement("accessor")
                    accoutpx.setAttribute("source", "#"+i.name+"s_rotation_euler_"+ax+"-output-array")
                    accoutpx.setAttribute("count", "%s" % (ii))
                    accoutpx.setAttribute("stride", "1")
                    paroutpx = doc.createElement("param")
                    paroutpx.setAttribute("name", "VALUE")
                    ...
                    # interpolation
                    sintpx = doc.createElement("source")
                    sintpx.setAttribute("id", i.name+"s_rotation_euler_"+ax+"-interpolation")
                    intpxfa = doc.createElement("Name_array")
                    intpxfa.setAttribute("id", i.name+"s_rotation_euler_"+ax+"-interpolation-array")
                    intpxfa.setAttribute("count", "%s" % (ii))
                    sintpxdat = doc.createTextNode("%s" % (intx))
                    intpxfa.appendChild(sintpxdat)
                    tcintpx = doc.createElement("technique_common")
                    accintpx = doc.createElement("accessor")
                    accintpx.setAttribute("source", "#"+i.name+"s_rotation_euler_"+ax+"-interpolation-array")
                    accintpx.setAttribute("count", "%s" % (ii))
                    accintpx.setAttribute("stride", "1")
                    parintpx = doc.createElement("param")
                    parintpx.setAttribute("name", "INTERPOLATION")
                    ...
                    # intangent
                    sintangpx = doc.createElement("source")
                    sintangpx.setAttribute("id", i.name+"s_rotation_euler_"+ax+"-intangent")
                    intangpxfa = doc.createElement("float_array")
                    intangpxfa.setAttribute("id", i.name+"s_rotation_euler_"+ax+"-intangent-array")
                    intangpxfa.setAttribute("count", "%s" % ((ii) * 2))
                    sintangpxdat = doc.createTextNode("%s" % (intangx))
                    intangpxfa.appendChild(sintangpxdat)
                    tcintangpx = doc.createElement("technique_common")
                    accintangpx = doc.createElement("accessor")
                    accintangpx.setAttribute("source", "#"+i.name+"s_rotation_euler_"+ax+"-intangent-array")
                    accintangpx.setAttribute("count", "%s" % (ii))
                    accintangpx.setAttribute("stride", "2")
                    parintangpx = doc.createElement("param")
                    parintangpx.setAttribute("name", "X")
                    ...
                    # outtangent
                    soutangpx = doc.createElement("source")
                    soutangpx.setAttribute("id", i.name+"s_rotation_euler_"+ax+"-outtangent")
                    outangpxfa = doc.createElement("float_array")
                    outangpxfa.setAttribute("id", i.name+"s_rotation_euler_"+ax+"-outtangent-array")
                    outangpxfa.setAttribute("count", "%s" % ((ii) * 2))
                    soutangpxdat = doc.createTextNode("%s" % (outtangx))
                    outangpxfa.appendChild(soutangpxdat)
                    tcoutangpx = doc.createElement("technique_common")
                    accoutangpx = doc.createElement("accessor")
                    accoutangpx.setAttribute("source", "#"+i.name+"s_rotation_euler_"+ax+"-outtangent-array")
                    accoutangpx.setAttribute("count", "%s" % (ii))
                    accoutangpx.setAttribute("stride", "2")
                    paroutangpx = doc.createElement("param")
                    paroutangpx.setAttribute("name", "X")
                    ...
                    # sampler
                    samx = doc.createElement("sampler")
                    samx.setAttribute("id", i.name+"s_rotation_euler_"+ax+"-sampler")
                    semip = doc.createElement("input")
                    semip.setAttribute("semantic", "INPUT")
                    semip.setAttribute("source", "#"+i.name+"s_rotation_euler_"+ax+"-input")
                    semop = doc.createElement("input")
                    semop.setAttribute("semantic", "OUTPUT")
                    semop.setAttribute("source", "#"+i.name+"s_rotation_euler_"+ax+"-output")
                    seminter = doc.createElement("input")
                    seminter.setAttribute("semantic", "INTERPOLATION")
                    seminter.setAttribute("source", "#"+i.name+"s_rotation_euler_"+ax+"-interpolation")
                    semintang = doc.createElement("input")
                    semintang.setAttribute("semantic", "IN_TANGENT")
                    semintang.setAttribute("source", "#"+i.name+"s_rotation_euler_"+ax+"-intangent")
                    semoutang = doc.createElement("input")
                    semoutang.setAttribute("semantic", "OUT_TANGENT")
                    semoutang.setAttribute("source", "#"+i.name+"s_rotation_euler_"+ax+"-outtangent")
                    samx.appendChild(semip)
                    samx.appendChild(semop)
                    samx.appendChild(seminter)
                    # samx.appendChild(semintang)
                    # samx.appendChild(semoutang)
                    chanx = doc.createElement("channel")
                    chanx.setAttribute("source", "#"+i.name+"s_rotation_euler_"+ax+"-sampler")
                    chanx.setAttribute("target", i.name+"s/rotation_"+ax+".ANGLE")
